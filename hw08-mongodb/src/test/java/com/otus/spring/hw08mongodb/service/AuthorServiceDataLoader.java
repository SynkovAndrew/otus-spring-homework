...
import com.otus.spring.hw08mongodb.dto.author.CreateOrUpdateAuthorRequestDTO;
...
@DataMongoTest
public class AuthorServiceDataLoader extends AbstractMongoDataLoader {
    @Autowired
    private AuthorRepository authorRepository;
    private AuthorService service;

    @Autowired
    public AuthorServiceDataLoader(MongoTemplate mongoTemplate) {
        super(mongoTemplate);
    }
